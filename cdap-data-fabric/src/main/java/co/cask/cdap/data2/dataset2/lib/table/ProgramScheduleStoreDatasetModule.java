...
import co.cask.cdap.data2.dataset2.lib.schedule.ProgramScheduleStoreDefinition;
...
public class ProgramScheduleStoreDatasetModule implements DatasetModule {
  ...
  public void register(DatasetDefinitionRegistry registry) {
    ...
    registry.add(new ProgramScheduleStoreDefinition(ProgramScheduleStoreDataset.class.getSimpleName(),
                                                    indexedTableDef));
  }
}
